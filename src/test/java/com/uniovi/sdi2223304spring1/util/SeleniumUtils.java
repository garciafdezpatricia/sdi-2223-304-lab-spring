package com.uniovi.sdi2223304spring1.util;
...
public class SeleniumUtils {
	...
	{
		Boolean resultado = 
				(new WebDriverWait(driver, java.time.Duration.ofSeconds(timeout))).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("//*[contains(text(),'" + text + "')]")));
	...
	{
		WebElement result =
				(new WebDriverWait(driver, java.time.Duration.ofSeconds(timeout))).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(xpath)));
